{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "my_stat=pd.read_csv('D:\\programming Python\\Stepic Machine leaning 02.2020\\my_stat.csv')"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "subset_2=my_stat.drop([0,4],axis=0).drop(['V1','V3'],axis=1)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "my_stat1=pd.read_csv('D:\\programming Python\\Stepic Machine leaning 02.2020\\my_stat_1.csv')"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "med=my_stat1[my_stat1.n_users>=0]\n",
    "med"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "my_stat1[my_stat1.n_users>=0].median().n_users"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "my_stat1.n_users=my_stat1.n_users.where(((my_stat1.n_users)>0),(my_stat1[my_stat1.n_users>=0].median().n_users)).astype(float)\n",
    "my_stat1"
   ]
  },
  {
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "mean_session_value_data=my_stat1.groupby(['group'],as_index=False).agg({'session_value':'mean'}).rename(columns={'session_value':'mean_session_value'})"
   ]
  },
  {
   "cell_type": "code",
